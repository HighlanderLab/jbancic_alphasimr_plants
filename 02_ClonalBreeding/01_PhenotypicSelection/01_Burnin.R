...
#####END ADDING TO GlobalParameters.R#####
...
#####BEGIN ADDING TO CreateParents.R#####
...
#####END ADDING TO RUNME.R#####
  ...
  #####BEGIN ADDING TO fillPipeline.R#####
  for(year in 1:16){
    # Year 1
    # Crossing block
...
#####BEGIN ADDING TO UpdateParents.R#####
    Parents = selectInd(ECT6, nInd = 20, use = "pheno")
#####END ADDING TO UpdateParents.R#####

#####BEGIN ADDING TO AdvanceYear.R#####
    # Year 16
