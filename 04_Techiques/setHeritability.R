...
# of a phenotype. This is shown using a trait affected by additive
...
# Option 1: By asigning the narrow sense heritability
######################################################################
...
# Option 2: By asigning the broad-sense heritability
######################################################################
pop = setPheno(pop, H2 = 0.5)
# Check heritability
cor(pop@pheno, pop@gv)^2
